...
const Product = (props) => {
	...
	// A component can change the quantity in the future
	product.quantity = 1;
	...
	if(!!product.installments) {
		...
		productInstallment = (
			<div className="installment">
				<span>or {products.installments} x</span><b>{product.currencyFormat} {util.formatPrice(installmentPrice, product.currencyId)}</b>
			</div>
		);
	}
